...
public:
	...
	void insert_from_front(Q data);	//insertion from front
	void insert_from_back(Q data);	//insertion from back
	void remove_from_front();	//removal from front
	void remove_from_back();	//removal from back
	void display();
	int size();		//getter for capacity
	void clear();	//for clearing deque
};
template<typename Q>
...
void deque<Q>::insert_from_front(Q data) {
	//basically traversing by decrementing front
	if (front == rear + 1) { cout << "Queue is already full.\n";	return; }
...
void deque<Q>::insert_from_back(Q data) {
	//basically traversing by incrementing rear
	if (front == rear + 1) {
...
void deque<Q>::remove_from_front() {
	//doing exact opposite of inserting from front
...
void deque<Q>::remove_from_back() {
	//doing exact opposite of decrementing from rear
